                                ...
                                @if($order->status === 'completed')
                                    <div class="mt-4 rounded-2xl border border-yellow-100 bg-yellow-50/40 p-4">
                                        <div class="flex items-start justify-between gap-3">
                                            <div class="min-w-0">
                                                <p class="font-bold text-sm text-gray-900 flex items-center gap-2">
                                                    ...
                                                    {{ $itemReview ? 'Ulasan Anda' : 'Belum Diulas' }}
                                                </p>
                                                @if($itemReview)
                                            ...
                                            <a href="{{ route('buyer.reviews.edit', $item->id) }}" class="shrink-0 inline-flex items-center gap-1.5 rounded-xl border border-yellow-200 bg-white px-3 py-2 text-xs font-bold text-yellow-700 hover:border-yellow-300 hover:bg-yellow-50 transition-colors">
                                        ...
                                        @if($reviewMedia->isNotEmpty())
                                            <div class="mt-3">
                                                <p class="text-xs font-bold text-gray-600 mb-2">Media ulasan</p>
