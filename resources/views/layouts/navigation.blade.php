        ...
        <div class="flex justify-between items-center h-16 sm:h-20 gap-4 sm:gap-8">
            ...
            <div class="flex items-center justify-end gap-3 sm:gap-6">
                ...
                @auth
                    ...
                    @endphp
                    <x-dropdown align="right" width="w-[300px] sm:w-96" contentClasses="py-0 overflow-hidden bg-white">
                        <x-slot name="trigger">
                ...
                @else
                    ...
                    <div class="block relative mr-2" @click.away="notifOpen = false">
                        <button @click="notifOpen = !notifOpen" class="text-gray-500 hover:text-brand-navy relative group transition-colors focus:outline-none mt-2">
                            <x-icon name="bell" class="w-6 h-6 sm:w-7 sm:h-7" />
                        </button>
                        
                        <div x-show="notifOpen" x-transition x-cloak class="absolute right-[-10px] sm:right-0 mt-3 w-[300px] sm:w-80 bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] border border-gray-100 z-50 overflow-hidden">
