...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased bg-gray-50 flex flex-col min-h-screen">
        ...
        <!-- Footer -->
        <footer class="bg-brand-navy text-white pt-16 pb-8 border-t-4 border-brand-orange mt-auto font-sans">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-12 gap-10 lg:gap-8 mb-12">
                    ...
                    <div class="col-span-1 md:col-span-4 lg:col-span-4 lg:pr-8">
                        ...
                        <div class="flex gap-4">
                            <a href="#" class="text-gray-300 hover:text-brand-orange transition-colors duration-300">
                    ...
                    <div class="col-span-1 md:col-span-4 lg:col-span-3">
                        <h4 class="font-bold text-[17px] mb-6 text-brand-orange tracking-wide">Metode Pengiriman</h4>
                        ...
                        <div class="mt-8 pt-6 border-t border-white/10">
                            <h4 class="font-bold text-[17px] mb-6 text-brand-orange tracking-wide">Metode Pembayaran</h4>
                            <div class="grid grid-cols-3 gap-2 pr-4 sm:pr-0">
                                ...
                                <div class="bg-white rounded p-1.5 flex items-center justify-center h-9 shadow-sm">
                                    <span class="text-[12px] font-black tracking-tighter text-orange-500 italic">BNI</span>
                                </div>
                                <div class="bg-white rounded p-1.5 flex items-center justify-center h-9 shadow-sm">
