                            ...
                            <div class="flex gap-3">
                                ...
                                <div class="text-xs text-orange-800 space-y-1">
                                    ...
                                    <ul class="list-disc pl-4 space-y-0.5">
                                        <li>Toko Anda akan <strong>menunggu verifikasi Admin</strong> sebelum bisa mencairkan dana.</li>
                                        <li>Anda tetap bisa langsung menambahkan produk setelah toko dibuat.</li>
                                        <li>Akun Anda akan otomatis menjadi akun <strong>Penjual + Pembeli</strong> (dual-role).</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
