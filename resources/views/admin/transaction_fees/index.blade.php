<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex items-start gap-3 mb-6">
            ...
            <div>
                <h1 class="text-2xl font-bold font-display text-gray-900">Biaya Transaksi Pembeli</h1>
                <p class="text-gray-500 text-sm mt-1">Biaya ini akan ditambahkan ke Grand Total pesanan pembeli secara langsung saat Checkout.</p>
            </div>
        </div>
