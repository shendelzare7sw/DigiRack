...
">
    <x-modal name="global-confirm-modal" maxWidth="sm">
        <div class="p-6">
            ...
            <div class="mt-6 flex justify-end gap-3">
                <button type="button" x-on:click="$dispatch('close-modal', 'global-confirm-modal')" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-full font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none transition ease-in-out duration-150">
                    Batal
                </button>
                
                <button type="button" 
                    x-on:click="if(formElement) { formElement.submit(); $dispatch('close-modal', 'global-confirm-modal'); }"
